...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 13), // void()(double *, double *, double *, double *, double *, double *, double *, double *, unsigned int, unsigned int, double)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 11), // double *
...
static void _cffi_d_charge_a_b_integral(double * x0, double * x1, double * x2, double * x3, double * x4, double * x5, double * x6, double * x7, unsigned int x8, unsigned int x9, double x10)
{
  charge_a_b_integral(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_charge_a_b_integral(PyObject *self, PyObject *args)
{
  double * x0;
  double * x1;
  double * x2;
  ...
  if (!PyArg_UnpackTuple(args, "charge_a_b_integral", 11, 11, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9, &arg10))
    return NULL;
...
#else
#  define _cffi_f_charge_a_b_integral _cffi_d_charge_a_b_integral
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "charge_a_b_integral", (void *)_cffi_f_charge_a_b_integral, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_charge_a_b_integral },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__four_matricies_to_diffusion_asymptotic(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__four_matricies_to_diffusion_asymptotic(void) { return NULL; }
#  else
     init_four_matricies_to_diffusion_asymptotic(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__four_matricies_to_diffusion_asymptotic(void)
{
  return _cffi_init("_four_matricies_to_diffusion_asymptotic", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_four_matricies_to_diffusion_asymptotic(void)
{
  _cffi_init("_four_matricies_to_diffusion_asymptotic", 0x2601, &_cffi_type_context);
}
#endif
